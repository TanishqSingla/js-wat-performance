(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 18052))
 (memory $0 1)
 (data (i32.const 1036) "<")
 ...
 (data (i32.const 1500) "<")
 (data (i32.const 1512) "\01\00\00\00*\00\00\00O\00b\00j\00e\00c\00t\00 \00a\00l\00r\00e\00a\00d\00y\00 \00p\00i\00n\00n\00e\00d")
 (data (i32.const 1564) "<")
 ...
 (export "ASbubbleSort" (func $export:assembly/index/ASbubbleSort))
 (start $~start)
 ...
 (func $export:assembly/index/ASbubbleSort (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
